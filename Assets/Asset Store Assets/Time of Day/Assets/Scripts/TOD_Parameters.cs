...
[Serializable] public class TOD_CycleParameters
{
	...
	public System.DateTime DateTime
	{
		get
		{
			...
			float s_f  = (m_f - m) * 60;
			int   s    = (int)s_f;
			float ms_f = (s_f - s) * 1000;
			int   ms   = (int)ms_f;

			return new System.DateTime(Year, Month, Day, h, m, s, ms, DateTimeKind.Utc);
		}
		set
		{
			Year  = value.Year;
...
[Serializable] public class TOD_AtmosphereParameters
{
	...
	public float Directionality = 0.6f;

	/// [0, 1]
	/// Intensity of the haziness of the sky at the horizon.
	public float Haziness = 0.6f;
...
[Serializable] public class TOD_DayParameters
{
	...
	public Color AmbientColor = new Color32(78, 97, 127, 255);
...
[Serializable] public class TOD_NightParameters
{
	...
	public Color AmbientColor = new Color32(50, 62, 81, 255);
...
[Serializable] public class TOD_MoonParameters
{
	...
	public Color HaloColor = new Color32(81, 104, 155, 25);
	...
	public TOD_MoonPositionType Position = TOD_MoonPositionType.OppositeToSun;
...
[Serializable] public class TOD_AmbientParameters
{
	...
	{
		UpdateInterval = Mathf.Max(0, UpdateInterval);
		Resolution     = Mathf.Clamp(Mathf.ClosestPowerOfTwo(Resolution), 2, 16);
	}
}
